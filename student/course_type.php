      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h1 class="m-0 text-dark">Python Course</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
This Specialization builds on the success of the Python for Everybody course and will introduce fundamental programming concepts including data structures, networked application program interfaces, and databases, using the Python programming language. In the Capstone Project, you’ll use the technologies learned throughout the Specialization to design and create your own applications for data retrieval, processing, and visualization.</b></p>
              </div>
            <div class="p-4">
            <div class="p-3">
      			 <i class="nav-icon fa fa-bookmark"> </i> <h4> <b> Python Courses </b> </h4><span>Follow the suggested order or choose your own.</span> 
      		</div>
          ...
          <div class="p-3">
             <i class="nav-icon fa fa-trophy"></i> <h4><b>Join Today</b></h4> 
                <span> <a href="https://www.coursera.org/learn/python">https://www.coursera.org/learn/python</a></span>
          </div>
<div class="p-3">
