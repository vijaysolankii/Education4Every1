          ...
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="Name of student..." required="true">
                </div>
                
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="Project Name..." required="true">
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="Languages..." required="true">
                </div>
                <div class="form-group">
                    <textarea id="compose-textarea" class="form-control" style="height: 100px">Comments...
                    </textarea>
                </div>
                <div class="form-group">
